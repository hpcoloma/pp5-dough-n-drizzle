...
urlpatterns = [
    ...
    path('order_management/<str:order_number>/update/', views.update_order_status, name='update_order_status'),
    path('order/delete/<order_number>/', views.delete_order, name='delete_order'),
]